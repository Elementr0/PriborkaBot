...
from callbacks import choose_subject, choose_date, handle_second_subgroup, handle_first_subgroup, handle_monday_schedule, handle_tuesday_schedule

from config import BOT_TOKEN

from aiogram import Bot, Dispatcher

from database.crud import create_tables, fill_schedule, get_day_full
...
async def main():
    ...
    dp.include_router(handle_tuesday_schedule.router)
